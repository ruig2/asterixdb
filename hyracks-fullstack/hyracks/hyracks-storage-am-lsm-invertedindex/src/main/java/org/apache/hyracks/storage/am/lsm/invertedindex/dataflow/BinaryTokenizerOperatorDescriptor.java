...
public class BinaryTokenizerOperatorDescriptor extends AbstractSingleActivityOperatorDescriptor {
    ...
    public BinaryTokenizerOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor recDesc,
            IBinaryTokenizerFactory tokenizerFactory, IFullTextConfigFactory fullTextConfigFactory, int docField,
    ...
    public IOperatorNodePushable createPushRuntime(IHyracksTaskContext ctx,
        ...
        return new BinaryTokenizerOperatorNodePushable(ctx,
                ...
                tokenizerFactory.createTokenizer(), fullTextConfigFactory.createFullTextConfig(), docField, keyFields,
                addNumTokensKey, writeKeyFieldsFirst, writeMissing, missingWriterFactory);
    }
}
