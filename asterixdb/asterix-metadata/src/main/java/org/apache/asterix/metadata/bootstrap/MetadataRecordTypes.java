...
public final class MetadataRecordTypes {
    ...
    public static final ARecordType INTERNAL_DETAILS_RECORDTYPE = createRecordType(
            ...
            new IAType[] { ASTRING, ASTRING,
                    new AOrderedListType(new AOrderedListType(ASTRING, null), null),
    ...
    public static final ARecordType DERIVEDTYPE_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, BuiltinType.ABOOLEAN,
    ...
    public static final ARecordType DATATYPE_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, ASTRING,
                    AUnionType.createUnknownableType(DERIVEDTYPE_RECORDTYPE), ASTRING },
            //IsOpen?
            true);
    //-------------------------------------- Dataverse ------------------------------------------//
    ...
    public static final ARecordType NODEGROUP_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, new AUnorderedListType(ASTRING, null),
                    ASTRING },
            //IsOpen?
            true);
    //----------------------------------------- Function ----------------------------------------//
    ...
    public static final ARecordType FUNCTION_RECORDTYPE = createRecordType(
            ...
            new IAType[] { ASTRING, ASTRING, ASTRING,
                    new AOrderedListType(ASTRING, null), ASTRING, ASTRING,
                    ASTRING, ASTRING,
    ...
    public static final ARecordType FEED_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, ASTRING,
                    new AUnorderedListType(FEED_ADAPTER_CONFIGURATION_RECORDTYPE, null), ASTRING },
            //IsOpen?
            true);
    ...
    public static final ARecordType FEED_CONNECTION_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, ASTRING, ASTRING, ASTRING,
                    new AUnorderedListType(ASTRING, null), ASTRING },
            //IsOpen?
            true);
    ...
    public static final ARecordType EXTERNAL_FILE_RECORDTYPE = createRecordType(
            ...
            // FieldTypes
            new IAType[] { ASTRING, ASTRING, BuiltinType.AINT32, ASTRING,
