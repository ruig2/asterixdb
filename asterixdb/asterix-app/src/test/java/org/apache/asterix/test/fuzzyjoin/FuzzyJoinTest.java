...
public class FuzzyJoinTest {
    ...
    private static final String PATH_BASE =
            StringUtils.join(new String[] { "src", "test", "resources", "fuzzyjoin" + File.separator }, File.separator);
    ...
    @Parameters(name = "FuzzyJoinTest {index}: {0}")
    ...
    public FuzzyJoinTest(TestCaseContext tcCtx) {
        this.tcCtx = tcCtx;
    }
